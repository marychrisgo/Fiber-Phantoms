...
def generate_and_count_filaments(volume, num_filaments, mode ='straight', pipe_radius=50, min_length=300, max_length=400, radius=3):
    ...
    while successful_filaments < num_filaments and total_attempts < max_total_attempts:
        if mode =='straight':
            filament = generate_3d_filament(volume, min_length, max_length, radius, pipe_radius)
        elif  mode == 'curve':
            filament = generate_3d_filament_curved(volume, min_length, max_length, radius, pipe_radius)
...
def generate_3d_filament(volume, min_length=300, max_length=400, radius=3, pipe_radius=50,
...
def generate_3d_filament_curved(volume, min_length=300, max_length=400, radius=3, pipe_radius=50, bend_radius=100, bend_center=250):
    attempts = 0
    max_attempts = 1000
    ...
    for step in range(max_length):
        ...
        filament.append(next_point_int.copy())
        center_point = next_point_int
